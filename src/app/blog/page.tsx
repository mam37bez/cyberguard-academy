...
export const metadata: Metadata = {
  title: 'Блог',
  description:
    'Блог CyberGuard Academy: статьи о кибербезопасности, цифровой защите, фишинге, безопасности детей в интернете и полезных инструментах.',
  alternates: {
    ...
    <div className="pt-24 pb-16">
      <div className="max-w-7xl mx-auto px-4">
        <SectionHeading
          badge="Блог"
          title="Статьи"
          subtitle="Материалы о кибербезопасности"
        />
