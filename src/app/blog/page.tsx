...
export const metadata: Metadata = {
  title: 'Блог',
  description: 'Блог CyberGuard Academy: статьи о кибербезопасности, цифровой защите, фишинге, безопасности детей в интернете и полезных инструментах.',
  alternates: {
              ...
              <Card variant="default" className="h-full">
                <CardContent className="flex flex-col h-full">
                  <div className="flex gap-2 mb-4">
                    ...
                    {p.featured && <Badge variant="warning" size="sm">⭐</Badge>}
                  </div>
