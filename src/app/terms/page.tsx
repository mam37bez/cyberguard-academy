    ...
    <div className="pt-24 pb-16">
      <div className="max-w-4xl mx-auto px-4">
        ...
        <p className="text-gray-400 mb-10">
          ...
          его материалов, форм обратной связи, образовательных разделов и интерактивных инструментов.
        </p>
        ...
        <div className="space-y-8 text-gray-300 leading-relaxed">
          ...
          <section>
            ...
            <p className="mt-3">
              ...
              пользователь самостоятельно принимает решения о применении
              рекомендаций с учётом своей ситуации, возраста, уровня подготовки и
              контекста.
            </p>
          </section>
