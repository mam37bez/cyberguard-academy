        ...
        <div className="max-w-4xl mx-auto space-y-8 text-slate-400 leading-relaxed">
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2 mt-3">
              ...
              <li>
                адрес ссылки (URL), если вы сами запускаете проверку в разделе инструментов безопасности: запрос
                обрабатывается на наших серверах и передаётся в сервис{' '}
                <span className="text-slate-300">Google Safe Browsing</span> для сравнения с базой известных угроз
                (условия обработки данных Google регулируются политиками Google).
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p className="mt-3">
              К таким сервисам относятся, в частности: хостинг и инфраструктура размещения, сервис отправки писем
              (обработка данных из форм), системы аналитики (при их подключении), а также{' '}
              <span className="text-slate-300">Google Safe Browsing</span>, если вы явно инициируете проверку URL в
              разделе инструментов — в этом случае указанный вами адрес передаётся Google для запроса к их базе угроз.
            </p>
          </section>
