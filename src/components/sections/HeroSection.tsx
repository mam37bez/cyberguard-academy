      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 py-32">
        <div className="text-center">
          ...
          <div className="mb-8 animate-float">
            <div className="inline-flex items-center justify-center w-24 h-24 rounded-2xl bg-gradient-to-br from-primary-500/20 to-cyber-green/20 border border-primary-500/30 text-6xl animate-shield-pulse">🛡️</div>
          </div>
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-white mb-6 leading-tight animate-slide-up">
            <span className="bg-gradient-to-r from-white via-primary-200 to-white bg-clip-text text-transparent">CyberGuard</span>
            <br />
            <span className="bg-gradient-to-r from-cyber-green via-cyber-blue to-primary-400 bg-clip-text text-transparent">Academy</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 animate-slide-up">
            <Link href="/courses"><Button size="lg" variant="primary">🎓 Выбрать курс</Button></Link>
          ...
          <div className="mt-20 grid grid-cols-2 md:grid-cols-4 gap-8 animate-fade-in">
            {[{v:'1500+',l:'Учеников'},{v:'98%',l:'Довольных родителей'},{v:'50+',l:'Курсов'},{v:'12',l:'Преподавателей'}].map(s=>(
              <div key={s.l} className="text-center">
                <div className="text-3xl md:text-4xl font-bold bg-gradient-to-r from-cyber-green to-cyber-blue bg-clip-text text-transparent mb-1">{s.v}</div>
