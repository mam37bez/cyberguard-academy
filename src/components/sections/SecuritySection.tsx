  ...
  return (
    <section className="py-24 bg-cyber-darker">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div
          ref={ref}
          className={`grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12 transition-all duration-700 ${
          ...
          {securityThreats.map((t) => (
            <Card key={t.id} variant="default">
              <CardContent>
                ...
                <h4 className="text-sm font-semibold text-cyber-green mb-2">Защита:</h4>
                ...
                <h4 className="text-sm font-semibold text-yellow-400 mb-2">Признаки:</h4>
